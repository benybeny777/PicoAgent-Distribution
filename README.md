...
PicoAgentの全体像をまとめた15ページのスライドを[PicoAgent-Intro.pptx](PicoAgent-Intro.pptx)に置いています。概要、3つの柱、スキル70種、AIモデルの選択、キャラクター、表示形式、プライバシー、開発者向け機能、動作環境、導入手順、ベータ版の制限、料金までを1枚ずつ扱います。内容はこのページと公開LPに合わせてあり、版が上がったら同じ範囲を更新します。
